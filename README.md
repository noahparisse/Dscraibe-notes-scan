...
```
cd existing_repo
git remote add origin https://gitlab.paris-digital-lab.com/rte/rte-f2025-p1/detection-notes.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.paris-digital-lab.com/rte/rte-f2025-p1/detection-notes/-/settings/integrations)
